...
describe('Watched List', () => {
  ...
  it('should be able to add an item even if it was previously removed from the list', () => {
    const list = new NumberWatchedList([1, 2, 3])
  ...
  it('should be able to remove an item even if it was previously added to the list', () => {
    const list = new NumberWatchedList([1, 2, 3])
